...
const About = () => {
    ...
    useEffect(() => {
      document.title = "Swastik's Portfolio | Web Developer & Designer | Front-End & Back-End Projects";
      document.querySelector('meta[name="description"]').setAttribute('content', "Swastik's portfolio showcases a collection of web development projects, front-end & back-end solutions, and design expertise. Explore creative work and contact for collaboration.");
    }, []);
  return (
    <div id='about' className="rounded-xl  rounded-t-[12px] rounded-b-[12px] shadow-[0_-2px_5px_rgba(0,0,0,0.1),0_2px_5px_rgba(0,0,0,0.1)]">
      
      {/* React Helmet to add dynamic SEO meta tags */}
      <Helmet>
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 pb-1 mx-auto">
          ...
          <div className="lg:w-4/5 ml-auto flex flex-wrap py-4">
            ...
            <div className="w-80 h-80 rounded-full overflow-hidden object-center flex items-center justify-center mx-auto lg:mx-0">
              <img alt="Swastik Mishra, Web Developer" className="object-cover lg:w-80 lg:h-80 w-full h-full object-center" src="/SwastikPortfolio/dp4.jpg" />
            </div>
            <div className="lg:w-1/2 w-full lg:pl-16 lg:py-6 mt-6 lg:mt-0 flex flex-col justify-center text-center lg:text-start">
              ...
              <p className="leading-relaxed text-lg mb-4">
                I have completed my Bachelors of Technology [2020-2024] in Computer Science from Vindhya Institute of Technology and Science, Satna (M.P.).
              </p>
              <p className="leading-relaxed text-lg mb-4">
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-5 mx-auto">
          <div className="flex flex-wrap -m-4 text-center">
            ...
            <div className="p-4 sm:w-1/4 w-1/2">
              <h2 className="title-font font-medium sm:text-4xl text-3xl text-gray-900">1,512</h2>
